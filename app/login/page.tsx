      ...
      <Card className="w-full max-w-md border-border/60 shadow-xl backdrop-blur-[2px]">
        <CardHeader className="space-y-3 text-center pb-8">
          ...
          <div className="space-y-1">
            <CardTitle className="text-2xl font-bold tracking-tight">Lycen</CardTitle>
            <CardDescription className="text-balance">
              Enter your email and password to access your Lycen
            </CardDescription>
          </div>
        </CardHeader>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="flex flex-col gap-6 pt-2 pb-8">
            <Button className="w-full h-11 text-sm font-semibold shadow-lg shadow-primary/20 transition-all active:scale-[0.98]" type="submit" disabled={loading}>
              {loading ? (
                <>
            ...
            <p className="text-center text-sm text-muted-foreground">
              <Link href="/register" className="text-primary hover:text-primary/80 hover:underline underline-offset-4 font-semibold transition-colors">
                Create an account
              </Link>
            </p>
          </CardFooter>
